      ...
      <section id="projects" className="py-16 px-4 bg-gray-100" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="grid gap-8 max-w-4xl mx-auto">
          <ProjectCard
            ...
            link="barker_zinc_finger_offtarget_analysis.pdf"
            linkLabel="View Paper"
            github="https://github.com/kbarker223/Genetic-Expression-Analysis"
          />
          <ProjectCard
          ...
          <ProjectCard
            title="Trailforge"
            description="Built a personalized hiking trail recommendation app in 24 hours at SB Hacks XII hackathon. Users connect their Strava account via OAuth and the app analyzes 
...
"
      ...
      <div className="absolute inset-0 opacity-20">
        <Image
          ...
          layout="fill"
          objectFit="cover"
          objectPosition="100% 30%" // <-- Centers the top of the image (saves heads!)
